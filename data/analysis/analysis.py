...
# #	plt.show()
# 	plt.suptitle(title+"="+','.join(c_types))
# 	fig.savefig(fig_path+title+"="+','.join(c_types)+'-bar_chart.png')
...
# 		plt.title(legends[i], va='bottom')
# 	plt.suptitle(title+"="+','.join(c_types))
# 	fig.savefig(fig_path+title+"="+','.join(c_types)+'-percentage.png')
# #	plt.show()
