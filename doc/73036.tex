...
\begin{itemize}
	\item Step 1: Compute the vector of criteria weights.\\
				...
				$$
	\item Step 2: Caculate the largest eigenvalue $\alpha_{max}$ and corresponding eigenvector Y of A. \\Assume corresponding eigenvector Y is 
	$$
		Y = [y_1,y_2,y_3]
	$$
	$$
	...
	$$
	\item Step 3: Consistency Analysis\\
			...
			\mbox{The Consistency Index (CI) is}  \quad CI= \frac{\alpha_{min}-1}{n-1} 
				...
				\end{table}
				%\fi
	\item Step 4:  Compute the performance of the four states for each factor.\\
